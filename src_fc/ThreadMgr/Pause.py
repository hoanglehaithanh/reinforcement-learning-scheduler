...
class Pause:
    ...
    def pause_producer(self):
        ...
        with self.cons_cv:              # Implementing Locking for Conditional Variable.
            self.cons_cv.notify_all()    # To notify all the Paused Consumer Threads to resume.
    ...
    def pause_consumer(self):
        ...
        with self.prod_cv:              # Implementing Locking for Conditional Variable.
            self.prod_cv.notify_all()    # To notify that all Paused Producer Threads to resume.
        with self.cons_cv:
